...
import CategoriesCheckbox from "../PracticeComponent/CategoriesCheckbox";
...
const Favorites = () => {
  ...
  useEffect(() => {
    const SessionData = JSON.parse(localStorage.getItem("isFavorite"));
              ...
              <div key={index}>
                <div className="relative top-0 left-0 ">
                  ...
                  <div className="absolute right-0 bottom-0 z-10 p-4">
                    ...
                    >
                      <GoHeartFill size={24} className={"text-[#4D37A4]"} />
                    </button>
                  </div>
                </div>
