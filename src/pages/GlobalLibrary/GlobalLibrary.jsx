        ...
        <div className="">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Game Library</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
              ...
              <div key={index}>
                ...
                <div className="flex justify-between my-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[#3BB515] text-base font-medium">
                      {event.avatar_name}
                    </p>
                  </div>
                ...
                <Link to={`/dashboard/globalLibrary/GlobalLibraryDetails`}>
                  <h1 className="mb-4 text-lg text-[#010792] font-medium leading-none">
                    {event.name}
                  </h1>
                </Link>
