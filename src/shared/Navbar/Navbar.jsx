    ...
    <nav>
      <div className="w-full h-[100px] bg-white relative px-[50px] flex justify-between items-center">
          <div className="flex flex-col items-center gap-1 ">
            <h2 className="text-blue-900 text-5xl font-extrabold font-roboto lowercase">
              FTP
            </h2>
        ...
        <div className="text-slate-900 text-2xl font-medium font-roboto w-full text-center">
          [Title....]
        </div>
      </div>
    </nav>
